...
export default function Home() {
  return (
    <div className="h-screen w-full pl-32 pr-28 overflow-y-auto flex-col bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#10100C] from-25% via-[#06080A] via-60% to-[#03050A] to-100%  ">
      <div className=" pb-72">
