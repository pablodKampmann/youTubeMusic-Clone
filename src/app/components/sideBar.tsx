...
export default function TopBar() {
    ...
    return (
        <div className="w-[15%] h-[91%] flex flex-col bg-[#030303] border-r border-[#292929]">
            <div className='mt-2 h-fit px-2 space-y-2 flex-col'>
                <Link href='/' className={`${pathname === '/' ? 'bg-white bg-opacity-10' : 'hover:bg-white transition duration-150 hover:bg-opacity-10'} flex text-sm tracking-wide font-medium  text-center rounded-lg  w-full justify-start px-4 items-center`}>
                    <GoHomeFill size={50} className='flex py-2.5 items-center justify-start mr-2' />Inicio
                </Link>
                <Link href='/explorer' className={`${pathname === '/explorer' ? 'bg-white bg-opacity-10' : 'hover:bg-white transition duration-150 hover:bg-opacity-10'} flex text-sm tracking-wide font-medium  text-center rounded-lg bg w-full  justify-start px-4 items-center`}>
                    <MdOutlineExplore size={50} className='flex  py-2.5 items-center justify-start mr-2' />Explorar
                </Link>
                <Link href='/library' className={`${pathname === '/library' ? 'bg-white bg-opacity-10' : 'hover:bg-white transition duration-150 hover:bg-opacity-10'} flex hover: text-sm tracking-wide font-medium  text-center rounded-lg  w-full  justify-start px-4 items-center`}>
                    <MdOutlineLibraryMusic size={50} className='flex  py-2.5 items-center justify-start mr-2' />Mi biblioteca
                </Link>
            </div>
            ...
            <div className='h-screen w-full mb-2  overflow-y-auto   pl-2 space-y-2 pr-4'>
                <button className='group focus:outline-none w-full relative hover:bg-[#353535] transition duration-150 px-4 py-2 text-left rounded-lg'>
